...
23) If a number contains the digit 8 more than 3 times, then it is lucky.
...
39) Create an array from user input.
...
75) Addition of two numerical strings.  
    Example:  
